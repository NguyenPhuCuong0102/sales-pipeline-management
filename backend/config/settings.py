...
SECRET_KEY = 'django-insecure-z2$#4nr1miwilf@q9_tej^&^&&a*+a(&v=1=!6nhqyj2i568$h'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sales_pipeline_db',  # Tên DB bạn vừa tạo
        'USER': 'postgres',           # Mặc định thường là postgres
        'PASSWORD': '0',  # Mật khẩu PostgreSQL của bạn
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
REST_FRAMEWORK = {
    ...
    # Quyền hạn: Mặc định phải đăng nhập mới làm được mọi thứ
